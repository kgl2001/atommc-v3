...
const rom far char* r = (const rom far char*)"ATOMMCV3BIN";
...
extern void Delay1KTCYx(int);

void INIT_SPI(BYTE highspeed)
{
   ...
   else
   {
	...
	TRISCbits.TRISC2 = 0;   // define ss as output	
...
{
  unsigned char TempVar = SSPBUF;      // Clear BF
  PIR1bits.SSPIF = 0;                  // Clear interrupt flag
  SSPBUF = output;                          // initiate bus cycle
